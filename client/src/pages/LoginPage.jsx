  ...
  return (
    <div className="grid min-h-screen place-items-center bg-gradient-to-br from-blue-500/20 via-sky-300/10 to-emerald-400/20 p-4">
      <form onSubmit={onSubmit} className="w-full max-w-md rounded-2xl border border-white/40 bg-white/25 p-8 shadow-2xl backdrop-blur-xl animate-fade-in">
        <h1 className="mb-2 font-display text-3xl font-semibold text-slate-800">Welcome back</h1>
        <p className="mb-6 text-sm text-slate-600">Sign in to continue your wellness journey.</p>
        ...
        <div className="mb-4">
          <div className="relative">
            ...
            />
            <label htmlFor="login-email" className="pointer-events-none absolute left-10 top-3 text-sm text-slate-500 transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-sm peer-focus:-top-2 peer-focus:text-xs peer-focus:text-primary peer-[:not(:placeholder-shown)]:-top-2 peer-[:not(:placeholder-shown)]:text-xs">
              Email
            </label>
          </div>
        ...
        <div className="mb-4">
          <div className="relative">
            ...
            />
            <label htmlFor="login-password" className="pointer-events-none absolute left-10 top-3 text-sm text-slate-500 transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-sm peer-focus:-top-2 peer-focus:text-xs peer-focus:text-primary peer-[:not(:placeholder-shown)]:-top-2 peer-[:not(:placeholder-shown)]:text-xs">
              Password
            </label>
        ...
        <p className="mt-4 text-sm text-slate-700">
          No account? <Link to="/register" className="inline-flex items-center gap-1 text-primary hover:underline">Register <ArrowRight className="h-3.5 w-3.5" /></Link>
        </p>
      </form>
    </div>
  )
